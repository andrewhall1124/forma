        ...
        {status?.connected ? (
          ...
          <form onSubmit={handleConnect} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full flex items-center justify-center gap-2 rounded-lg bg-blue-600 py-2.5 text-sm font-medium hover:bg-blue-500 disabled:opacity-50 transition-colors"
            >
